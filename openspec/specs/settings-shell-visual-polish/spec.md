...
Settings window shell visual quality: classic cool-neutral palette with product-feel surface hierarchy, restrained brand-blue selection, and unchanged configuration semantics.
